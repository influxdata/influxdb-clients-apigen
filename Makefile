...
generate-python:
	...
	@docker-compose run java mvn -f ./openapi-generator/core/pom.xml compile exec:java -Dexec.mainClass="com.influxdb.MergeContracts" -Dexec.args="oss.yml invocable-scripts.yml"
